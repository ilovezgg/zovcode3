      ...
      <div className={z.aboutUsMain}>
        <div className={z.container}>
          <div className={z.textAbout}>
            ...
            комфорт и долговечность. Будь то роскошный особняк или уютный
            коттедж, мы готовы стать вашим надежным партнером. Наши проекты
            отличаются безупречным качеством, соответствующим самым высоким
            стандартам, и при этом остаются доступными по цене.
          </div>
