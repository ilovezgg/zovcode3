    ...
    <div>
      <div className={z.footerBackground}>
        <div className={z.footerMain}>
          {isMobile ? (
            <div className={z.mobileFooter}>
              <div className={z.mobileUrls}>
                <Link to="/" className={z.mobileLink}>
                  Главная
                </Link>
                <Link to="/contacts" className={z.mobileLink}>
                  Контакты
                </Link>
                <Link to="/catalog" className={z.mobileLink}>
                  Каталог
                </Link>
                <Link to="/we" className={z.mobileLink}>
                  О нас
                </Link>
                <Link to="/callback" className={z.mobileLink}>
                  Личный кабинет
                </Link>
<div className={z.containerForNew}>
<div className={z.tg}>
